...
<section clas="articulos">
    ...
    <article  class="art ">
        ...
        <section class="destacado">
            <h2 style="text-align: center; color: rgba(136, 133, 133, 0.904) ; font-size:xx-large;">NUESTROS PROFES</h2> <br> <br>
            <article class="profes">
                ...
                <p>
                   <h2> Él es el profe Juanda</h2> <br>
                    ...
                    - Especialista en entrenamiento deportivo con énfasis en planificación y periodización de la UdeA <br>
                    - Diplomado en docencia universitaria PCJIC <br>
                    - Curso en el desarrollo de las manifestaciones de la fuerza y la hipertrofia muscular UdeA <br>
                    - Curso en fisiología del envejecimiento y prescripción de actividad física en el adulto mayor UdeA<br>
                    - Curso de rumba aeróbica UdeA<br>
                  <h3>Su experiencia es:</h3>
                    - Profesor del club deportivo Alianza Bello <br>
                    - Profesor academia de Fútbol Total Itagüí <br>
                    - Preparador físico selección Girardota de fútbol categoría Primera A <br>
                ...
                <p>
                    ...
                    Y tiene 23 años de edad
                     <h3>Sus Estudios son: </h3>
                        ...
                        -Fisioterapia en formación <br>
                        -Certificación en vendajes neuromusculares <br>
                    
                 <h3>Su experiencia es:</h3>

                  -Profesor en Escuela de formación ESFUGIR <br>
...
<hr style="width: 80%; position: center; color:whitesmoke;"></hr>
    ...
    <div class="videos">
        <h3>ALGUNOS EJERCICIOS PARA QUE PRACTIQUES EN CASA</h3>
        <iframe class="vid" width="400" height="350" src="https://www.youtube.com/embed/S-XUIiKrjrs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <iframe class="vid" width="400" height="350" src="https://www.youtube.com/embed/fw4xbj54UnQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
        <iframe class="vid" width="400" height="350" src="https://www.youtube.com/embed/SzdgMJUSE-c" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
        
    </div>
        

        <footer>   
            <hr style="height: 0px;border:1px dashed;">
            
            <article>
<p>
    <h3 style="margin-top: 80px;font-weight:bolder">¿NECESITAS AYUDA?</h3>
Politicas de privacidad <br><br>
